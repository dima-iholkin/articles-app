...
public static class ManageNavPages
{
    ...
    public static string AccountMergeList => "AccountMergeList";
    ...
    public static string? AccountMergeNavClass(ViewContext viewContext) => 
        PageNavClass(viewContext, AccountMergeList);
